...
<!-- drawer component -->
<div
    id="drawer-payment-type"
    class="gradient2 text-white fixed bottom-0 left-0 right-0 z-40 w-full p-4 overflow-y-auto transition-transform bg-white dark:bg-gray-800 translate-y-full"
    tabindex="-1"
    aria-labelledby="drawer-bottom-label"
>
    <button
        type="button"
        data-drawer-hide="drawer-payment-type"
    ...
    <div class="font-sans flex justify-center items-center flex-col">
        <section
            class="min-h-90 p-4 rounded-lg py-20 space-y-8 flex text-white flex-col justify-center items-center w-4/5"
        >
