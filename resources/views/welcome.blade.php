...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans myBg">
        <div class="flex flex-col h-screen">
            ...
            <header class="flex-1 mx-auto container pb-4 flex flex-col">
                <img
                    ...
                    class="w-1/2 mx-auto animate-pulse"
                />
                <div class="mt-auto flex items-center">
                    <div class="h-1 flex-1 bg-gray-700"></div>
                    <div class="mx-2 w-16 h-16">
                        <img
                            src="/storage/images/triangle.svg"
        ...
        <section class="my-8">
            ...
            <div class="container mx-auto rounded-lg gradient2 pb-8 min-h-64">
                <table class="w-full border-separate border-spacing-y-8">
                    ...
                    <tbody>
                        ...
                        <tr class="text-white">
                            ...
                            <td class="">
                                <button
                                    class="p-1 bg-white font-semibold text-black w-20 rounded-full"
                                >
                                    view
                                </button>
                            </td>
                ...
                <div class="flex justify-center">
                    <button class="p-1 bg-white font-semibold min-w-20 mx-2">
                        Previous
                    </button>
                    <button class="p-1 bg-white font-semibold min-w-20 mx-2">
                        Next
        ...
        <section>
            <h1
                class="text-4xl text-center font-semibold text-white my-20 uppercase"
            >
                about
            </h1>
            <div class="container flex h-long mx-auto my-16">
                <div class="relative w-1/2 h-80 mr-8">
                    <div
                        class="w-80 h-full rounded-lg flex items-center justify-center gradient2 block absolute top-0"
                    >
                        <img src="/storage/images/car1.png" class="h-40" />
                    </div>
                    <div
                        class="w-80 h-full rounded-lg flex items-center justify-center gradient2 block absolute top-60 left-40"
                    >
                ...
                <div class="">
                    <p class="text-lg text-white my-4">
                        ...
                        elit. Accusantium, nihil. Deserunt numquam expedita fuga
                        veniam, eos earum molestias quasi, voluptate dicta
                        nesciunt soluta delectus id aliquid laboriosam doloribus
                        quo nam?
                    </p>
        ...
        <section>
            ...
            <div class="container mx-auto pb-8 flex justify-between flex-wrap">
                <div
                    class="px-4 py-8 gradient2 rounded-lg w-60 h-80 flex flex-col"
                >
                    <p class="text-lg text-white">
                        "Lorem ipsum dolor, sit amet consectetur adipisicing
                        elit. Minima amet laudantium tempora nostrum architecto
                        alias? Eveniet, repellat culpa id ullam quos suscipit."
                    </p>
                    <div class="flex justify-between mt-auto items-center">
                        ...
                        <h3 class="text-sm text-white">20 October</h3>
                    </div>
                </div>
                <div
                    class="px-4 py-8 gradient2 rounded-lg w-60 h-80 flex flex-col"
            ...
            <div class="container mx-auto pb-8">
                <div class="md:w-3/5 mx-auto rounded-lg gradient2 p-8">
                    <form action="" class="flex flex-col space-y-4">
                        <input
                            class="border-0 border-b-2 bg-transparent h-8"
                            type="text"
                            placeholder="Name"
                        />
                        <input
                            type="text"
                            class="border-0 bg-transparent border-b-2 h-8"
                            placeholder="Email"
                        />
                        <textarea
                            name="message"
                            class="border-0 border-b-2 h-40 bg-transparent"
                            id="message"
